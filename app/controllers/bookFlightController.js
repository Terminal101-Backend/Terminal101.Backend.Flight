...
console.log('providerError ==> ', bookedFlight.providerError)
    if (!bookedFlight.providerError) {
      ...
      try {
        ...
        console.log('Reject issued by error -> ', e);
        issued = false;
        bookedFlight.statuses.push({
          status: "REJECTED",
          description: e,
      ...
      if (!!issued) {
        (async () => {
          ...
          const path = await flightTicketController.generatePdfTicket(userToken, generatePdfTicket);
          // TODO: Send SMS
